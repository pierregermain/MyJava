 ...
 * 
 * Pierre W. Bertram: Esta librería es de commons-net 2.0 mofificada para funcionar en Java 1.4
 * 
 */
...
implements Configurable
{
      ...
      throws IOException
    {
        ...
        { // We must be in PASSIVE_LOCAL_DATA_CONNECTION_MODE
            ...
            //PWB             __parsePassiveModeReply(_replyLines.get(_replyLines.size() - 1));     
    ...
    public boolean enterRemotePassiveMode() throws IOException
    {
        ...
        //PWB         __parsePassiveModeReply(_replyLines.get(0));
    ...
    public String printWorkingDirectory() throws IOException
    {
        if (pwd() != FTPReply.PATHNAME_CREATED)
            return null;
        //PWB         return __parsePathname(_replyLines.get( _replyLines.size() - 1));
    ...
    public String getSystemName() throws IOException
    {
      ...
      // a positive completion.
        if (__systemName == null && FTPReply.isPositiveCompletion(syst()))
        	//PWB             __systemName = _replyLines.get(_replyLines.size() - 1).substring(4);
    ...
    public String[] listNames(String pathname) throws IOException
    {
        ...
        //PWB results = new ArrayList<String>();
        ...
        if (completePendingCommand())
        {
            ...
            //PWB             return results.toArray(names);
