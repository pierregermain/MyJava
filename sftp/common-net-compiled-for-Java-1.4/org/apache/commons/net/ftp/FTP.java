...
public class FTP extends SocketClient
{
    ...
    //PWB private StringBuilder __commandBuffer = new StringBuilder();
    private StringBuffer __commandBuffer = new StringBuffer();

    protected int _replyCode;
    // PWB     protected ArrayList<String> _replyLines;
    ...
    public FTP()
    {
        ...
        //PWB         _replyLines = new ArrayList<String>();
    ...
    public String getReplyString()
    {
        ...
        // PWB         buffer = new StringBuilder(256);
        ...
        java.util.Iterator i = _replyLines.iterator();
        while (i.hasNext()){
